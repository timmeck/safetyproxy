"""Auth middleware -- API key protection for SafetyProxy.

SECURITY: ALL endpoints require auth when SAFETYPROXY_API_KEY is set.
...
class AuthMiddleware(BaseHTTPMiddleware):
    """API key middleware. Active when SAFETYPROXY_API_KEY is set.
